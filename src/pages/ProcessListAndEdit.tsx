...
//     const requiredPartOptions = allParts.filter((item) => item.type !== "product");
//     const targetItemOptions = allParts.filter((item) => item.type !== "part");
...
//                     bom_name: editingProcess.name.trim(),
//                     bom_description: editingProcess.description.trim(),
//                     item_name: editingProcess.itemName.trim(),
//                     items,
//                 }),
//             });
...
//                                 {targetItemOptions.map((p) => (
//                                     <option key={p.id} value={p.name}>
//                                         {p.name}（{p.type === 'intermediate' ? '中間品' : '完成品'}）
//                                     </option>
//                                 ))}
//                             </select>
//                         </label>
